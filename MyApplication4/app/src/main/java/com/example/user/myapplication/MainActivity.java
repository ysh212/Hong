...
public class MainActivity extends AppCompatActivity{
    ...
    private Thread checkUpdate = new Thread() {
        ...
        public void run() {
            try {
                ...
                while (true) {
                    Log.w("something is running", "something is running");

                    line = networkReader.readLine();

                    //Log.d(this.getClass().getName(), line);
                    html = line;
                    Log.d("DataRecieved", line);
    ...
    //받은 데이터를 Toast 기능을 통해 출력 - 위젯의 경우 handler를 이용
